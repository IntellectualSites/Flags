...
public abstract class BooleanFlag<F extends AbstractFlag<Boolean, F>> extends
    AbstractFlag<Boolean, F> {
     ...
     */
    protected BooleanFlag(final boolean value) {
        super(value);
    }
    ...
    @Override public F parse(@NotNull String input) throws FlagParseException {
        if (positiveValues.contains(input.toLowerCase(Locale.ENGLISH))) {
            ...
            throw new FlagParseException(this, input, "Value has to be true or false");
        }
    }
